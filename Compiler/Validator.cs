...
public static class Validator
{
    ...
    private static void CheckDuplicateClasses(List<ClassNode> classes)
    {
        ...
        foreach (var group in duplicateGroups)
            throw new QlangCompileException($"Duplicate class found: '{group.Key.Name}'", group.First().Line, "Validator");
    }
    ...
    private static void CheckDuplicateAssignments(ClassNode @class)
    {
        ...
        foreach (var group in duplicateGroups)
            throw new QlangCompileException($"Duplicate assignment found: '{group.Key.VariableName}' in class '{@class.Name}'", group.First().Line, "Validator");
    }
}