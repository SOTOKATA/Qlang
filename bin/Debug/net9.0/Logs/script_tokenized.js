...
Keyword(class) Identifier(Number) Colon 
	...
	Keyword(function) Identifier(randInt) LParen Keyword(let) Identifier(min) Comma Keyword(let) Identifier(max) RParen Colon 
		...
		RBrace 
		Identifier(min) Equals Identifier(toFixedInt) LParen Identifier(Parser) Dot Identifier(asNumber) LParen Identifier(min) RParen RParen Semicolon 
		Identifier(max) Equals Identifier(toFixedInt) LParen Identifier(Parser) Dot Identifier(asNumber) LParen Identifier(max) RParen RParen Semicolon 
...
Keyword(class) Identifier(String) Colon 
	...
	Keyword(function) Identifier(append) LParen Keyword(let) Identifier(collection) RParen Colon 
		...
		Keyword(if) Identifier(Array) Dot Identifier(isArray) LParen Identifier(collection) RParen Equals Equals Keyword(false) Colon 
			LBrace 
			Identifier(Throw) Dot Identifier(parceException) LParen Identifier(___STRING_24___) RParen Semicolon 
		RBrace 
		Keyword(let) Identifier(result) Equals Identifier(___STRING_25___) Semicolon 
	...
	Keyword(function) Identifier(length) LParen RParen Colon 
		LBrace 
		Identifier(Console) Dot Identifier(print) LParen Identifier(_value) RParen Semicolon 
		Keyword(return) Identifier(_native) LParen Identifier(___STRING_26___) Comma Identifier(_str) LParen Identifier(_value) RParen RParen Semicolon 
	RBrace 
	...
	Keyword(function) Identifier(isNullOrWhitespace) LParen Keyword(let) Identifier(str) RParen Colon 
		LBrace 
		Keyword(return) Identifier(_native) LParen Identifier(___STRING_28___) Comma Identifier(_str) LParen Identifier(str) RParen RParen Semicolon 
	RBrace 
	...
	Keyword(function) Identifier(trimStart) LParen RParen Colon 
		LBrace 
		Keyword(return) Identifier(_native) LParen Identifier(___STRING_30___) Comma Identifier(_str) LParen Identifier(_value) RParen RParen Semicolon 
	RBrace 
	...
	Keyword(function) Identifier(subString) LParen Keyword(let) Identifier(startPos) Comma Keyword(let) Identifier(length) RParen Colon 
		...
		RBrace 
		Keyword(return) Identifier(_native) LParen Identifier(___STRING_34___) Comma Identifier(_str) LParen Identifier(_value) RParen Comma Identifier(startPos) Comma Identifier(length) RParen Semicolon 
	RBrace 
RBrace 
Keyword(class) Identifier(Time) Colon 
	...
	Keyword(function) Identifier(wait) LParen Keyword(let) Identifier(millisec) RParen Colon 
		...
		Keyword(if) Identifier(Number) Dot Identifier(isNumber) LParen Identifier(millisec) RParen Equals Equals Keyword(false) Colon 
			LBrace 
			Identifier(Throw) Dot Identifier(parseException) LParen Identifier(___STRING_35___) RParen Semicolon 
		RBrace 
		Identifier(millisec) Equals Identifier(Number) Dot Identifier(toFixedInt) LParen Identifier(millisec) RParen Semicolon 
		Identifier(_native) LParen Identifier(___STRING_36___) Comma Identifier(millisec) RParen Semicolon 
	RBrace 
RBrace 
Keyword(class) Identifier(Console) Colon 
	LBrace 
	Keyword(private) Keyword(let) Identifier(defFColor) Equals Identifier(___STRING_37___) Semicolon 
	Keyword(private) Keyword(let) Identifier(defBColor) Equals Identifier(___STRING_38___) Semicolon 
	Keyword(function) Identifier(print) LParen Keyword(let) Identifier(message) RParen Colon 
		LBrace 
		Identifier(_native) LParen Identifier(___STRING_39___) Comma Identifier(_str) LParen Identifier(message) RParen RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(println) LParen Keyword(let) Identifier(message) RParen Colon 
		LBrace 
		Identifier(print) LParen Identifier(message) Plus Identifier(___STRING_40___) RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(readln) LParen RParen Colon 
		LBrace 
		Keyword(return) Identifier(_native) LParen Identifier(___STRING_41___) RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(readkey) LParen Keyword(let) Identifier(intercept) RParen Colon 
		LBrace 
		Keyword(return) Identifier(_native) LParen Identifier(___STRING_42___) Comma Identifier(intercept) RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(isKeyAvailable) LParen RParen Colon 
		LBrace 
		Keyword(return) Identifier(_native) LParen Identifier(___STRING_43___) RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(cursorVisible) LParen Keyword(let) Identifier(visible) RParen Colon 
		LBrace 
		Identifier(_native) LParen Identifier(___STRING_44___) Comma Identifier(visible) RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(clear) LParen RParen Colon 
		LBrace 
		Identifier(_native) LParen Identifier(___STRING_45___) RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(setCursorPosition) LParen Keyword(let) Identifier(x) Comma Keyword(let) Identifier(y) RParen Colon 
		LBrace 
		Identifier(_native) LParen Identifier(___STRING_46___) Comma Identifier(x) Comma Identifier(y) RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(setForeColor) LParen Keyword(let) Identifier(color) RParen Colon 
		LBrace 
		Identifier(_native) LParen Identifier(___STRING_47___) Comma Identifier(color) RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(setBackColor) LParen Keyword(let) Identifier(color) RParen Colon 
		LBrace 
		Identifier(_native) LParen Identifier(___STRING_48___) Comma Identifier(color) RParen Semicolon 
	RBrace 
...
Keyword(class) Identifier(Object) Colon 
	...
	Keyword(function) Identifier(toString) LParen RParen Colon 
		LBrace 
		Keyword(return) Identifier(___STRING_49___) Semicolon 
	RBrace 
RBrace 
Keyword(class) Identifier(Parser) Colon 
	...
	Keyword(static) Keyword(function) Identifier(asInt) LParen Keyword(let) Identifier(object) RParen Colon 
		LBrace 
		Keyword(return) Identifier(_native) LParen Identifier(___STRING_50___) Comma Identifier(object) RParen Semicolon 
	RBrace 
	Keyword(static) Keyword(function) Identifier(asFloat) LParen Keyword(let) Identifier(object) RParen Colon 
		LBrace 
		Keyword(return) Identifier(_native) LParen Identifier(___STRING_51___) Comma Identifier(object) RParen Semicolon 
	RBrace 
	Keyword(static) Keyword(function) Identifier(asString) LParen Keyword(let) Identifier(object) RParen Colon 
		LBrace 
		Keyword(return) Identifier(_native) LParen Identifier(___STRING_52___) Comma Identifier(object) RParen Semicolon 
	RBrace 
	Keyword(static) Keyword(function) Identifier(asNumber) LParen Keyword(let) Identifier(object) RParen Colon 
		LBrace 
		Keyword(return) Identifier(_native) LParen Identifier(___STRING_53___) Comma Identifier(object) RParen Semicolon 
	RBrace 
RBrace 
Keyword(class) Identifier(Throw) Colon 
	...
	Keyword(function) Identifier(exception) LParen Keyword(let) Identifier(message) RParen Colon 
		LBrace 
		Identifier(_native) LParen Identifier(___STRING_54___) Comma Identifier(_str) LParen Identifier(message) RParen RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(nonImplementException) LParen RParen Colon 
		LBrace 
		Identifier(exception) LParen Identifier(___STRING_55___) RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(parseException) LParen Keyword(let) Identifier(error) RParen Colon 
		LBrace 
		Identifier(exception) LParen Identifier(___STRING_56___) Plus Identifier(error) RParen Semicolon 
	RBrace 
RBrace 
Keyword(class) Identifier(Cmd) Colon 
	LBrace 
	Keyword(function) Identifier(pt) LParen RParen Colon 
		LBrace 
		Identifier(Console) Dot Identifier(println) LParen Identifier(___STRING_57___) RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(get) LParen RParen Colon 
		LBrace 
		Keyword(return) Identifier(String) Dot Identifier(new) LParen Identifier(___STRING_58___) RParen Semicolon 
	RBrace 
RBrace 
Keyword(function) Identifier(main) LParen RParen Colon 
	LBrace 
	Identifier(Console) Dot Identifier(println) LParen Identifier(Cmd) Dot Identifier(get) LParen RParen Dot Identifier(length) LParen RParen RParen Semicolon 
RBrace 
