...
namespace core: {
    ...
    function str(const obj):
        return core::Object.toString(obj);
}
...
class Console: {
    ...
    function printVerbatim(let message): {
        ...
        _native(___STRING_104___, message);
    }

    
    function printlnVerbatim(let message = ___STRING_105___): {
        message = getStr(message);

        _native(___STRING_106___, message + _str(___STRING_107___));
    }

    
    function readln(): {
        return String.new(_native(___STRING_108___));
    }

    function readkey(const<Boolean> intercept = false): {
        return String.new(_native(___STRING_109___, intercept));
    }

    function isKeyAvailable(): {
        return _native(___STRING_110___);
    }

    function cursorVisible(const<Boolean> visible): {
        _native(___STRING_111___, visible);
    }

    
    function clear(): {
        _native(___STRING_112___);
    }
    ...
    function setCursorPosition(let<Number> x, let<Number> y): {
        ...
        _native(___STRING_113___, x, y);
    }

    
    function setForeColor(let<String> color):
        _native(___STRING_114___, color);
    ...
    function resetColors():
        _native(___STRING_116___);

    function width(): 
        return _native(___STRING_117___);
...
function main(): {
    core::String.new(___STRING_120___);
}
