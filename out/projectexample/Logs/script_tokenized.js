Keyword(namespace) Identifier(core) Colon 
	LBrace 
...
Keyword(namespace) Identifier(core) Colon 
	...
	Keyword(return) Identifier(core) Colon 
	Colon 
	Identifier(Object) Dot Identifier(toString) LParen Identifier(obj) RParen Semicolon 
RBrace 
Keyword(namespace) Identifier(core) Colon 
	LBrace 
...
Keyword(namespace) Identifier(core) Colon 
	...
	Keyword(class) Identifier(Array) Colon 
		...
		Keyword(function) Identifier(isCollection) LParen Keyword(const) Identifier(collection) RParen Colon 
		...
		Keyword(function) Identifier(contains) LParen Keyword(const) Identifier(item) RParen Colon 
		...
		Keyword(function) Identifier(push) LParen Keyword(const) Identifier(item) RParen Colon 
...
Keyword(class) Identifier(Console) Colon 
	LBrace 
	Keyword(private) Keyword(function) Identifier(getStr) LParen Keyword(const) Identifier(message) RParen Colon 
		LBrace 
		Keyword(if) LParen Identifier(Object) Dot Identifier(isNull) LParen Identifier(message) RParen RParen Colon 
		Keyword(return) Identifier(___STRING_99___) Semicolon 
		Keyword(if) LParen Identifier(Object) Dot Identifier(isSimplify) LParen Identifier(message) RParen Equals Equals Keyword(false) RParen Colon 
			LBrace 
			Keyword(return) Identifier(str) LParen Identifier(message) RParen Semicolon 
		RBrace 
		Keyword(return) Identifier(message) Semicolon 
	RBrace 
	...
	Keyword(function) Identifier(printVerbatim) LParen Keyword(let) Identifier(message) RParen Colon 
		LBrace 
		Identifier(message) Equals Identifier(getStr) LParen Identifier(message) RParen Semicolon 
		Identifier(_native) LParen Identifier(___STRING_104___) Comma Identifier(message) RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(printlnVerbatim) LParen Keyword(let) Identifier(message) Equals Identifier(___STRING_105___) RParen Colon 
		LBrace 
		Identifier(message) Equals Identifier(getStr) LParen Identifier(message) RParen Semicolon 
		Identifier(_native) LParen Identifier(___STRING_106___) Comma Identifier(message) Plus Identifier(_str) LParen Identifier(___STRING_107___) RParen RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(readln) LParen RParen Colon 
		LBrace 
		Keyword(return) Identifier(String) Dot Identifier(new) LParen Identifier(_native) LParen Identifier(___STRING_108___) RParen RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(readkey) LParen Keyword(const) Less Identifier(Boolean) Greater Identifier(intercept) Equals Keyword(false) RParen Colon 
		LBrace 
		Keyword(return) Identifier(String) Dot Identifier(new) LParen Identifier(_native) LParen Identifier(___STRING_109___) Comma Identifier(intercept) RParen RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(isKeyAvailable) LParen RParen Colon 
		LBrace 
		Keyword(return) Identifier(_native) LParen Identifier(___STRING_110___) RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(cursorVisible) LParen Keyword(const) Less Identifier(Boolean) Greater Identifier(visible) RParen Colon 
		LBrace 
		Identifier(_native) LParen Identifier(___STRING_111___) Comma Identifier(visible) RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(clear) LParen RParen Colon 
		LBrace 
		Identifier(_native) LParen Identifier(___STRING_112___) RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(setCursorPosition) LParen Keyword(let) Less Identifier(Number) Greater Identifier(x) Comma Keyword(let) Less Identifier(Number) Greater Identifier(y) RParen Colon 
		...
		Identifier(_native) LParen Identifier(___STRING_113___) Comma Identifier(x) Comma Identifier(y) RParen Semicolon 
	RBrace 
	Keyword(function) Identifier(setForeColor) LParen Keyword(let) Less Identifier(String) Greater Identifier(color) RParen Colon 
	Identifier(_native) LParen Identifier(___STRING_114___) Comma Identifier(color) RParen Semicolon 
	...
	Identifier(_native) LParen Identifier(___STRING_116___) RParen Semicolon 
	Keyword(function) Identifier(width) LParen RParen Colon 
	Keyword(return) Identifier(_native) LParen Identifier(___STRING_117___) RParen Semicolon 
...
Keyword(function) Identifier(main) LParen RParen Colon 
	LBrace 
	Identifier(core) Colon 
	Colon 
	Identifier(String) Dot Identifier(new) LParen Identifier(___STRING_120___) RParen Semicolon 
RBrace 
