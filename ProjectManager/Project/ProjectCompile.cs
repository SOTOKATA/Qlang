...
public partial class Project
{
    ...
    public bool Compile(bool isPublish, bool saveAST = false)
    {
        ...
        return _qlang.Compile(rootPath, outputName, isPublish, saveAST);
    }

    public void Run(List<string?>? args)
    {
        if (Compile(false, _compileSettings.GetBool(CompileSettings.SaveAlsoASTVersion)))
